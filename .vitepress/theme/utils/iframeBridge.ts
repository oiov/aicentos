...
function createScrollPayload() {
  ...
  const rawProgress =
    maxScrollable === 0 ? (scrollTop > 0 ? 1 : 0) : scrollTop / maxScrollable;
...
function postToTrustedParent(
  message: ReturnType<typeof createScrollPayload>,
): void {
